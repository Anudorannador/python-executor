...
Python: 3.12.12 (C:\Users\<REDACTED_USER>\AppData\Roaming\uv\tools\python-executor-mcp\Scripts\python.exe)
pyx: 0.1.0
...
=== Environment Keys ===
[Local: C:\Users\<REDACTED_USER>\repo\python-executor\.env]
...
=== Available Commands ===
  ...
  ✓ ping               ✓ pip (25.3)         ✓ powershell         
  ✓ pwsh (7.5.4)       ✓ python (3.12.12)   ✓ python3            
  ✓ pyx (0.1.0)        ✓ rustc (1.91.1)     ✓ rustup (1.28.2)    
  ✓ scp                ✓ sort               ✓ ssh                
  ✓ tar (3.8.2)        ✓ tree               ✓ uv (0.9.13)        
  ✓ winget (1.12.350)  ✓ xz (5.2.6)         ✓ yarn               
  ✗ 7z                 ✗ 7za                ✗ apt                
  ✗ apt-get            ✗ awk                ✗ aws                
  ✗ az                 ✗ black              ✗ brew               
  ✗ bundle             ✗ cat                ✗ clang              
  ✗ clang++            ✗ cmake              ✗ composer           
  ✗ dnf                ✗ docker             ✗ dpkg               
  ✗ emacs              ✗ fd                 ✗ ffmpeg             
  ✗ g++                ✗ gcc                ✗ gcloud             
  ✗ gem                ✗ gh                 ✗ go                 
